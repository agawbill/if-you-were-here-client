...
function (_React$Component) {
  ...
  function DanteEditor(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleHTMLPaste", function (text, html) {
      var currentBlock = (0, _index.getCurrentBlock)(_this.state.editorState); // TODO: make this configurable
      ...
      var pushedContentState = _draftJs.EditorState.push(_this.state.editorState, newContent, 'insert-fragment');
